    ...
    <div name='projects' className='w-full bg-[#f9f9f9]'>
        <div className='py-8 md:py-32 px-8 max-w-[1000px] mx-auto justify-center flex flex-col '>
            <div className="pb-2">
                ...
                <p className='text-center font-[500]  text-primary text-[18px]'> Formal education is great and all - but I'm most proud of my personal projects.</p>
            </div>
            ...
            <div className='bg-white text-primary rounded-xl py-4 px-4 flex flex-col gap-8  md:flex-row justify-between'>
                <div>
                    ...
                    <ul className='font-[600] list-disc text-[#555]'>
                        <li>Developed</li>
                    </ul>
