    ...
    <div name='home' className='w-full h-screen bg-[#f9f9f9] select-none'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col-reverse md:flex-row justify-center items-center h-full gap-2 md:gap-12'>
          <AnimateOnScroll className='text-primary font-[700] max-w-[500px] align-top'>
            ...
            <p className='text-4xl  text-primary font-[700] font-[Poppins]  text-center md:text-6xl py-2 md:text-left'>Hey there! I'm Alexander <img src={wave}  className=' pb-1 size-[1em] inline hover:animate-waving-hand animate-waving-hand-once' alt="wave"></img></p>
            ...
            <div className='py-4 text-2xl text-secondary flex justify-center md:justify-start flex-row gap-2'>
               <a  className="hover:scale-105" href="https://linkedin.com/in/alexanderblack957"  target="_blank">< FiLinkedin/> </a>
               <FiGithub/>
               </div>
          </AnimateOnScroll>
          <AnimateOnScroll>
