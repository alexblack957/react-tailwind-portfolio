    ...
    <div name='home' className='w-full h-screen bg-[#f9f9f9]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col-reverse md:flex-row justify-center items-center h-full gap-2 md:gap-12'>
          <div className='text-primary font-[700] max-w-[500px] align-top'>
            <h1 className='text-4xl text-center md:text-5xl py-6 md:text-left transition-opacity ease-in duration-700'>Hey there! I'm Alexander 👋</h1>
            <p className='text-center font-[500] md:text-left text-[18px]'> I'm looking for a software engineering position - and this website will detail why you should hire me. Brisbane, Australia.</p>
